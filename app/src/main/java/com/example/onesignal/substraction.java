...
public class substraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        done=findViewById(R.id.btnsubstraction);
        ...
        int number19=Integer.parseInt(getIntent().getStringExtra("keynum9"));
            ...
            public void onClick(View view) {
                ...
                /*
                 */
                Intent intent11=new Intent(substraction.this,resultaddition.class);
                /*
                ...
                int number31=number11-number1;
                int number32=  number12-number2;
                int number33=number13-number3;
                int number34=  number14-number4;
                int number35=number15-number5;
                int number36=  number16-number6;
                int number37=number17-number7;
                int number38=  number18-number8;
                int number39=number19-number9;
              ...
              //  Toast.makeText(substraction.this,"substraction"+n1,Toast.LENGTH_LONG).show();
