...
public class multiply extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        done=findViewById(R.id.btnmultiply);
        int number11=Integer.parseInt(getIntent().getStringExtra("keynum21"));
        int number12=Integer.parseInt(getIntent().getStringExtra("keynum22"));
        int number13=Integer.parseInt(getIntent().getStringExtra("keynum23"));
        int number14=Integer.parseInt(getIntent().getStringExtra("keynum24"));
        int number15=Integer.parseInt(getIntent().getStringExtra("keynum25"));
        int number16=Integer.parseInt(getIntent().getStringExtra("keynum26"));
        int number17=Integer.parseInt(getIntent().getStringExtra("keynum27"));
        int number18=Integer.parseInt(getIntent().getStringExtra("keynum28"));
        int number19=Integer.parseInt(getIntent().getStringExtra("keynum29"));
        done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent11=new Intent(multiply.this,resultaddition.class);
                ...
                int number31=(number11*number1)+(number12*number4)+(number13*number7);
                int number32= (number11*number2)+(number12*number5)+(number13*number8);
                int number33=(number11*number3)+(number12*number6)+(number13*number9);
                int number34= (number14*number1)+(number15*number4)+(number16*number7);
                int number35=(number14*number2)+(number15*number5)+(number16*number8);
                int number36= (number14*number3)+(number15*number6)+(number16*number9);
                int number37=(number17*number1)+(number18*number4)+(number19*number7);
                int number38=  (number17*number2)+(number18*number5)+(number19*number8);
                int number39=(number17*number3)+(number18*number6)+(number19*number9);
                ...
                Toast.makeText(multiply.this,"substraction"+n1,Toast.LENGTH_LONG).show();
